# 🍎 APPLE APP STORE CONNECT — REVIEW NOTES & RELEASE INFO (v1.0.5)

## 📌 1. APP REVIEW NOTES (DÀNH CHO ĐỘI NGŨ DUYỆT APP CỦA APPLE)
*(Sao chép nguyên văn đoạn tiếng Anh dưới đây và dán vào ô **App Review Information / Notes** trên App Store Connect)*
...
As our store operations run in real time with active retail staff, our internal testing and early user feedback uncovered several critical operational issues that needed immediate resolution. We have thoroughly addressed all of them in this comprehensive release (Version 1.0.5, Build 7):
...
## 📌 2. WHAT'S NEW IN THIS VERSION (DÀNH CHO NGƯỜI DÙNG TRÊN APP STORE)
*(Sao chép nội dung này dán vào ô **What's New in This Version**)*

### 🇻🇳 Tiếng Việt:
```text
Phiên bản 1.0.5 mang đến các nâng cấp quan trọng về chấm công và trải nghiệm sử dụng:
...
### 🇬🇧 English:
```text
Version 1.0.5 brings key enhancements for shift operations and overall stability:
...
- Optimized schedule registration: Pinned action buttons and smooth scrolling for multi-shift selection.
- General performance and UI stability improvements.
```
